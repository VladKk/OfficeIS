    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            BaseButton {
                ...
                borderColor: Style.mainAppColor
                onClicked: Global.mainStackView.replacePage("qrc:/gui/pages/account/LoginUser.qml")
            }
        }
    }
        ...
        function validateUserData() {
            ...
            if (!errors.length && _usrPass.validInput && _usrPass2.validInput && _registerLocalUserPage.similarPasswords) {
                ...
                if (!res) {
                    ...
                    Global.mainStackView.replacePage("qrc:/gui/pages/account/LoginUser.qml", {args: {userName: _userName.text}});
                } else if (res === 1) {
